    ...
    switch (this.type) {
      ...
      case "INCOME":
        this.value = collectedEvents.reduce((eventAcc, currentEvent) => {
          const filteredLifebar = currentEvent.effect.lifebars.find(
      ...
      case "THIRDPILLAR":
        this.value = collectedEvents.reduce((eventAcc, currentEvent) => {
          const filteredLifebar = currentEvent.effect.lifebars.find(
            (lifebar) => lifebar.type === "THIRDPILLAR"
          );
          if (filteredLifebar) {
            return eventAcc + filteredLifebar.value;
          }
      ...
      case "SECONDPILLAR":
        this.value = collectedEvents.reduce((eventAcc, currentEvent) => {
          const filteredLifebar = currentEvent.effect.lifebars.find(
            (lifebar) => lifebar.type === "SECONDPILLAR"
          );
          if (filteredLifebar) {
            return eventAcc + filteredLifebar.value;
          }
